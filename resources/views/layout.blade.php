...
<html lang="en">
    ...
    <body>
        ...
        <nav id="myNavbar" class="navbar navbar-default" role="navigation">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/">LPNU Projects</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="{{ route('user.index') }}"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Команда</a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('project.show') }}"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Проекти</a>
                        </li>
                        ...
                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle">Завдання <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('task.show') }}"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Всі завдання</a></li>
                                <li><a href="{{ route('task.create') }}"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Новий</a></li>
                            </ul>
                        </li>
        ...
        <section class="main-content" style="min-height: 680px;">
        <div class="container">   
