...
<form id="task_form" action="{{ route('task.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-md-8">
        <label>Створити завдання <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></label>

        <div class="form-group">
            <input type="text" class="form-control" placeholder="Enter Task Title" name="task_title">
        </div>

        <label>Прикріпити файли (png,gif,jpeg,jpg,txt,pdf,doc) <span class="glyphicon glyphicon-file" aria-hidden="true"></span></label>
        <div class="form-group">
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            <label>deadline <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></label>
        ...
        <div class="btn-group">
            <input class="btn btn-primary" type="submit" value="Створити" onclick="return validateForm()">
