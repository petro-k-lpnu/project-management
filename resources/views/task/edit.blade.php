...
-->
    ...
    <div class="col-md-8">
		...
		<div class="form-group">
        <label>Додати файли (png,gif,jpeg,jpg,txt,pdf,doc) <span class="glyphicon glyphicon-file" aria-hidden="true"></span></label>
	...
	<div class="col-md-4">
        ...
        <div class="form-group">
			 <label>Виконавець <span class="glyphicon glyphicon-user" aria-hidden="true"></span></label>
        ...
        <div class="form-group">
			 <label>Проект <span class="glyphicon glyphicon-pushpin" aria-hidden="true"></span></label>
		...
		<div class="form-group">
			<label>Пріоритет <span class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span></label>
			<select name="priority" class="form-control">
				@if( $task->priority == 0 )
			  		<option value="0" selected>Звичайний</option>
		...
		<div class="form-group">
			...
			<select name="completed" class="form-control">
				@if( $task->completed == 0 )
			  		<option value="0" selected>Не завершений</option>
			  		<option value="1">Завершений</option>
			  	@else
			  		<option value="0">Не завершений</option>
			  		<option value="1" selected>Завершений</option>
			  	@endif
			</select>
		</div>
        ...
        <div class="form-group">
            <label>Дата закінчення <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></label>
